...
// ============================================
// 🔥 LWAZI-MD MINI - COMPLETE SETTINGS
// 👑 Developer: lwazi-md
...
module.exports = {
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || '💕⃝🕊️ LWAZI MD Mini 💕⃝🕊️',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || 'lwazi-ᴍᴅ',
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ lwazi-ᴍᴅ',
     ...
     * @type {string}
     */
    IMAGE_PATH: process.env.IMAGE_PATH || 'https://i.ibb.co/gMHMZG7B/file-0000000055e081fd98bbebe40367a206-png.png',

    /**
     * @description WhatsApp channel link for updates
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbDK7drI1rcoEQNE1K3S',

    /**
     * @description WhatsApp group invite link
     * @type {string}
     */
    GROUP_LINK: process.env.GROUP_LINK || 'https://chat.whatsapp.com/EGdoI02Sjd9GTKDESndANB?s=cl&p=a&ilr=4',

    /**
     * @description Owner WhatsApp link
     * @type {string}
     */
    OWNER_LINK: process.env.OWNER_LINK || 'https://wa.me/27640942215',

    /**
     * @description Repository link
     * @type {string}
     */
    REPO: process.env.REPO || 'no repo available 🚫',
