...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for Lwazi-MD bot",
    category: "download",
    use: ".pair 27323***",
    filename: __filename
    ...
    try {
        ...
        const response = await axios.get(`https://Lwazi-mini-bot-e4ec84c138eb.herokuapp.com/code?number=${encodeURIComponent(phoneNumber)}`);
